...
export declare function createCompareReport({ boundingBoxes, data, fileName, folders, size, testContext: { commandName, instanceData: { app, browser, deviceName, isIOS, isMobile, platform, }, framework, parent, tag, title }, }: {
    boundingBoxes: {
        diffBoundingBoxes: BoundingBox[];
        ignoredBoxes: IgnoreBoxes[];
    };
...
//# sourceMappingURL=createCompareReport.d.ts.map